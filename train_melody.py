...
from dataloader import MelodyDataloader

# copy from train.py

# train basic melody

os.system('rm melody_logs/*')
writer = SummaryWriter('melody_logs')
...
loader = MelodyDataloader(params_loader)
...
for epoch in range(epochs):
    ...
    for i, data in enumerate((loader)):
        ...
        basic_melody, xseq, pad_offset = data
