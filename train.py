...
from dataloader import POP909BasicMelodyDataloader

# train basic melody

os.system('rm tensorboard_logs/*')
...
loader = POP909BasicMelodyDataloader(params_loader)
